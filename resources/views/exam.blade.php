...
<body>
<h1>Magento 2 Associate Exam</h1>
<div class="flex-center position-ref full-height">
    <div class="content">
        ...
        <div class="content-container">
            ...
            @endphp
            @foreach ($data as $row)
                <div class="question-wrapper" id="question-{{$row['id']}}" data-id="{{$row['id']}}">
                    <div class="question">
                        {{$row['question']}}
                    </div>
                    <div class="answer">
        ...
        <button type="button" class="btn btn-primary" id="complete" data-question="1">Complete</button>
    </div>
</div>
</body>
